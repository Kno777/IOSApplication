...
class TeamsViewModel {
    ...
    private(set) var teams: [Team] = [
        Team(id: .arsenal,
             ...
             founded: "October 1886", manager: .init(name: "Mikel Arteta", job: .manager)),
        Team(id: .astonVilla,
            name: "Aston Villa",
             ...
             founded: "November 1874", manager: .init(name: "Dean Smith", job: .headCoach)),
        Team(id: .brighton,
             name: "Brighton",
             ...
             founded: "June 1901", manager: .init(name: "Graham Potter", job: .headCoach)),
        Team(id: .burnley,
            name: "Burnley",
             ...
             founded: "May 1882", manager: .init(name: "Sean Dyche", job: .manager)),
        Team(id: .chelsea,
            name: "Chelsea",
             ...
             founded: "March 1905", manager: .init(name: "Frank Lampard", job: .headCoach)),
        Team(id: .everton,
            name: "Everton",
             ...
             founded: "1878", manager: .init(name: "Carlo Ancelotti", job: .manager)),
        Team(id: .fulham,
            name: "Fulham",
             ...
             founded: "1879", manager: .init(name: "Scott Parker", job: .headCoach)),
        Team(id: .leeds,
            name: "Leeds",
             ...
             founded: "October 1919", manager: .init(name: "Marcelo Bielsa", job: .headCoach)),
        Team(id: .leicester,
            name: "Leicester",
             ...
             founded: "1884", manager: .init(name: "Brendan Rodgers", job: .manager)),
        Team(id: .liverpool,
            name: "Liverpool",
             ...
             founded: "June 1892", manager: .init(name: "Jürgen Klopp", job: .manager)),
        Team(id: .manchesterCity,
            name: "Manchester City",
             ...
             founded: "1880", manager: .init(name: "Pep Guardiola", job: .manager)),
        Team(id: .manchesterUnited,
            name: "Manchester United",
             ...
             founded: "1902", manager: .init(name: "Ole Gunnar Solskjær", job: .manager)),
        Team(id: .newcastle,
            name: "Newcastle United",
             ...
             founded: "December 1892", manager: .init(name: "Steve Bruce", job: .manager)),
        Team(id: .palace,
            name: "Crystal Palace",
             ...
             founded: "September 1905", manager: .init(name: "Roy Hodgson", job: .manager)),
        Team(id: .sheffield,
            name: "Sheffield United",
             ...
             founded: "March 1889", manager: .init(name: "Chris Wilder", job: .manager)),
        Team(id: .southampton,
            name: "Southampton",
             ...
             founded: "November 1885", manager: .init(name: "Ralph Hasenhüttl", job: .manager)),
        Team(id: .tottenham,
            name: "Tottenham Hotspurs",
             ...
             founded: "September 1882", manager: .init(name: "José Mourinho", job: .manager)),
        Team(id: .westBrom,
            name: "West Brom",
             ...
             founded: "1878", manager: .init(name: "Slaven Bilić", job: .manager)),
        Team(id: .wolves,
            name: "Wolves",
